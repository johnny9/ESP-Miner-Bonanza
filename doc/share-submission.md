...
This report describes the hardware-tested candidate before the subsequent
[master integration](power-management-master-integration.md), which has its
own software validation record.
