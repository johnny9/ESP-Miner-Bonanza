                                                   ...
                                                   float frequency_mhz)
{
    ...
    if (config->family.asic.id == BZM) {
        return frequency_mhz >= 800.0f && frequency_mhz <= 2000.0f;
    }
                                                 ...
                                                 uint16_t voltage_mv)
{
    ...
    if (config->family.asic.id == BZM) {
        /* Aggregate rail bounds for four series BZM chips. */
        return voltage_mv >= 2100 && voltage_mv <= 3200;
    }
...
/* Aggregate TPS546 rail presets. Custom values remain available through the
 * existing overclock unlock, subject to the 2.1..3.2 V hardware bounds. */
static const uint16_t BZM_VOLTAGE_OPTIONS[]    = {
    2800, 2850, 2900, 2950, 3000, 3050, 3100, 3150, 3200, 0
};

static const uint16_t BM1373_VOLTAGE_OPTIONS[] = {1000, 1060, 1100, 1150, 1200, 1250,                   0};

static const AsicConfig ASIC_BM1397 = { .id = BM1397, .name = "BM1397", .chip_id = 1397, .frequency_tunable = true, .default_frequency_mhz = 425, .frequency_options = BM1397_FREQUENCY_OPTIONS, .default_voltage_mv = 1400, .voltage_options = BM1397_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 168, .small_core_count =  672, .hash_domains = 1, .default_asic_timeout = 20, .hardware_version_rolling = false, .software_midstates = 4, .hashrate_test_percentage_target = 0.85};
static const AsicConfig ASIC_BM1366 = { .id = BM1366, .name = "BM1366", .chip_id = 1366, .frequency_tunable = true, .default_frequency_mhz = 485, .frequency_options = BM1366_FREQUENCY_OPTIONS, .default_voltage_mv = 1200, .voltage_options = BM1366_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 112, .small_core_count =  894, .hash_domains = 4, .default_asic_timeout = 2000, .hardware_version_rolling = true, .software_midstates = 0, .hashrate_test_percentage_target = 0.85};
static const AsicConfig ASIC_BM1368 = { .id = BM1368, .name = "BM1368", .chip_id = 1368, .frequency_tunable = true, .default_frequency_mhz = 490, .frequency_options = BM1368_FREQUENCY_OPTIONS, .default_voltage_mv = 1166, .voltage_options = BM1368_VOLTAGE_OPTIONS, .difficulty = 256, .core_count =  80, .small_core_count = 1276, .hash_domains = 4, .default_asic_timeout = 500, .hardware_version_rolling = true, .software_midstates = 0, .hashrate_test_percentage_target = 0.80};
static const AsicConfig ASIC_BM1370 = { .id = BM1370, .name = "BM1370", .chip_id = 1370, .frequency_tunable = true, .default_frequency_mhz = 525, .frequency_options = BM1370_FREQUENCY_OPTIONS, .default_voltage_mv = 1150, .voltage_options = BM1370_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 128, .small_core_count = 2040, .hash_domains = 4, .default_asic_timeout = 500, .hardware_version_rolling = true, .software_midstates = 0, .hashrate_test_percentage_target = 0.85};
static const AsicConfig ASIC_BM1370XP = { .id = BM1370, .name = "BM1370", .chip_id = 1370, .frequency_tunable = true, .default_frequency_mhz = 400, .frequency_options = BM1370_FRQUENCY_XP_OPTIONS, .default_voltage_mv = 1150, .voltage_options = BM1370_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 128, .small_core_count = 2040, .hash_domains = 4, .default_asic_timeout = 500, .hardware_version_rolling = true, .software_midstates = 0, .hashrate_test_percentage_target = 0.85};
static const AsicConfig ASIC_BM1370_HEX = { .id = BM1370, .name = "BM1370", .chip_id = 1370, .frequency_tunable = true, .default_frequency_mhz = 690, .frequency_options = BM1370_FREQUENCY_OPTIONS, .default_voltage_mv = 1200, .voltage_options = BM1370_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 128, .small_core_count = 2040, .hash_domains = 4, .default_asic_timeout = 500, .hardware_version_rolling = true, .software_midstates = 0, .hashrate_test_percentage_target = 0.85};
static const AsicConfig ASIC_BM1373 = { .id = BM1373, .name = "BM1372/BM1373", .chip_id = 1372, .frequency_tunable = true, .default_frequency_mhz = 327, .frequency_options = BM1373_FREQUENCY_OPTIONS, .default_voltage_mv = 1000, .voltage_options = BM1373_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 128, .small_core_count = 6725, .hash_domains = 4, .default_asic_timeout = 500, .hardware_version_rolling = true, .software_midstates = 0, .init_retry_attempts = 3, .domain_hashrate_scale = 2.0f, .hashrate_test_percentage_target = 0.85};
static const AsicConfig ASIC_BZM = { .id = BZM, .name = "BZM", .chip_id = 0xB0A0, .reference_clock_mhz = 50, .default_frequency_mhz = 800, .frequency_options = BZM_FREQUENCY_OPTIONS, .frequency_tunable = true, .default_voltage_mv = 2800, .voltage_options = BZM_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 236, .small_core_count = 236, .hash_domains = 1, .hashrate_test_percentage_target = 0.85, .default_asic_timeout = 1000, .hardware_version_rolling = true};
...
static const FamilyConfig FAMILY_MAX         = { .id = MAX,         .name = "Max",        .asic = ASIC_BM1397,   .asic_count = 1, .max_power =  25, .power_offset = 5,  .nominal_voltage = 5,  .voltage_domains = 1, .voltage_tunable = true, .swarm_color = "red",      .tps546_config = &TPS546_CONFIG_DEFAULT, };
static const FamilyConfig FAMILY_ULTRA       = { .id = ULTRA,       .name = "Ultra",      .asic = ASIC_BM1366,   .asic_count = 1, .max_power =  25, .power_offset = 5,  .nominal_voltage = 5,  .voltage_domains = 1, .voltage_tunable = true, .swarm_color = "purple",   .tps546_config = &TPS546_CONFIG_DEFAULT, };
static const FamilyConfig FAMILY_HEX         = { .id = HEX,         .name = "Hex",        .asic = ASIC_BM1366,   .asic_count = 6, .max_power =  90, .power_offset = 12, .nominal_voltage = 12, .voltage_domains = 3, .voltage_tunable = true, .swarm_color = "orange",   .tps546_config = &TPS546_CONFIG_HEX, };
static const FamilyConfig FAMILY_SUPRA       = { .id = SUPRA,       .name = "Supra",      .asic = ASIC_BM1368,   .asic_count = 1, .max_power =  40, .power_offset = 5,  .nominal_voltage = 5,  .voltage_domains = 1, .voltage_tunable = true, .swarm_color = "blue",     .tps546_config = &TPS546_CONFIG_DEFAULT, };
static const FamilyConfig FAMILY_GAMMA       = { .id = GAMMA,       .name = "Gamma",      .asic = ASIC_BM1370,   .asic_count = 1, .max_power =  40, .power_offset = 5,  .nominal_voltage = 5,  .voltage_domains = 1, .voltage_tunable = true, .swarm_color = "green",    .tps546_config = &TPS546_CONFIG_DEFAULT, };
static const FamilyConfig FAMILY_GAMMA_DUO   = { .id = GAMMA_DUO,   .name = "GammaDuo",   .asic = ASIC_BM1370XP, .asic_count = 2, .max_power =  40, .power_offset = 5,  .nominal_voltage = 5,  .voltage_domains = 1, .voltage_tunable = true, .swarm_color = "green",    .tps546_config = &TPS546_CONFIG_DEFAULT, };
static const FamilyConfig FAMILY_SUPRA_HEX   = { .id = SUPRA_HEX,   .name = "SupraHex",   .asic = ASIC_BM1368,   .asic_count = 6, .max_power = 120, .power_offset = 25, .nominal_voltage = 12, .voltage_domains = 3, .voltage_tunable = true, .swarm_color = "darkblue", .tps546_config = &TPS546_CONFIG_HEX, };
static const FamilyConfig FAMILY_GAMMA_TURBO = { .id = GAMMA_TURBO, .name = "GammaTurbo", .asic = ASIC_BM1370,   .asic_count = 2, .max_power =  60, .power_offset = 10, .nominal_voltage = 12, .voltage_domains = 1, .voltage_tunable = true, .swarm_color = "cyan",     .tps546_config = &TPS546_CONFIG_GAMMA_TURBO, };
static const FamilyConfig FAMILY_NAJA_DUO    = { .id = NAJA_DUO,    .name = "NajaDuo",    .asic = ASIC_BM1373,   .asic_count = 2, .max_power =  60, .power_offset = 0,  .nominal_voltage = 12, .voltage_domains = NAJA_DUO_VOLTAGE_DOMAINS, .voltage_tunable = true, .swarm_color = "magenta",  .tps546_config = &TPS546_CONFIG_NAJA_DUO, };
static const FamilyConfig FAMILY_GAMMA_HEX   = { .id = GAMMA_HEX,   .name = "GammaHex",   .asic = ASIC_BM1370_HEX, .asic_count = 6, .max_power = 180, .power_offset = 25, .nominal_voltage = 12, .voltage_domains = GAMMA_HEX_VOLTAGE_DOMAINS, .voltage_tunable = true, .swarm_color = "cyan", .tps546_config = &TPS546_CONFIG_GAMMA_HEX, };
static const FamilyConfig FAMILY_BONANZA     = { .id = BONANZA,     .name = "Bonanza",    .asic = ASIC_BZM,      .asic_count = 4, .max_power = 140, .power_offset = 0,  .nominal_voltage = 12, .voltage_domains = 1, .voltage_tunable = true,  .swarm_color = "yellow",   };
...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = "1002", .family = FAMILY_BONANZA, .pins = BITAXE_ORIGINAL_PINS, .display_backend = DISPLAY_BACKEND_BONANZA_I2C,                                                       .TPS546 = true, .bonanza_bridge = true,                                   .power_consumption_target = 0,  },
};
