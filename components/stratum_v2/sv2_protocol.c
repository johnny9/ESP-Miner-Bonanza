                                      ...
                                      bool *has_min_ntime_out, bool *version_rolling_allowed_out)
{
    ...
    if (prefix_len > MAX_COINBASE_PREFIX_LEN || prefix_len > job_out->coinbase_prefix_capacity || (prefix_len > 0 && !job_out->coinbase_prefix)) {
    ...
    if (suffix_len > MAX_COINBASE_SUFFIX_LEN || suffix_len > job_out->coinbase_suffix_capacity || (suffix_len > 0 && !job_out->coinbase_suffix)) {
