...
bool BM1368_send_work(GlobalState *GLOBAL_STATE, const asic_job_t *template)
{
    ...
    _send_BM1368((TYPE_JOB | GROUP_SINGLE | CMD_WRITE), (uint8_t *)&job, sizeof(bm13xx_job_packet_t), BM1368_DEBUG_WORK);
    return true;
}
