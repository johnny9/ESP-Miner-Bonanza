...
bool BM1370_send_work(GlobalState *GLOBAL_STATE, const asic_job_t *template)
{
    ...
    _send_BM1370((TYPE_JOB | GROUP_SINGLE | CMD_WRITE), (uint8_t *)&job, sizeof(bm13xx_job_packet_t), BM1370_DEBUG_WORK);
    return true;
}
