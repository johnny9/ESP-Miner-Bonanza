...
esp_err_t bm1397_fake_receive_work(uint8_t *buffer, int size, uint64_t *timestamp_us);
int bm1397_stub_count_chips(uint16_t count, uint16_t chip_id, int response_length);
